...
def apply_store(store: FeatureStore):
    ...
    entities_new = [
        entity for entity in list_entities if entity.name not in previous_entities_name
    ]
    feature_views_new = [
        fv for fv in list_feature_views if fv.name not in previous_feature_views_name
    ]
